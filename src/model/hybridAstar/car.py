...
WB = WHEEL_BASE  # rear to front wheel
W = WIDTH  # width of car
LF = FRONT_HANG + WHEEL_BASE  # distance from rear to vehicle front end
LB = REAR_HANG  # distance from rear to vehicle back end
MAX_STEER = VALID_STEER[1]  # [rad] maximum steering angle
